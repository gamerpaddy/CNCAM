...
| occt-import-js | 0.0.23 | `occt/occt-import-js.js`, `occt/occt-import-js.wasm` | LGPL-2.1 (OCCT exception) — dynamic WASM-module usage; audit before commercial release |
